...
<div class="container-fluid">
		<div class="row">
			...
			List<ProDtls> list2 = dao2.getAllMachines();
			for (ProDtls p : list2) {
			%>
			<div class="col-md-3">
				<div class="card crd-ho mt-2">
					<div class="card-body text-center">
						...
						<%
						 ...
						 <a href="view_pro.jsp?pid=<%=p.getProId()%>"class="btn btn-success btn-sm ml-1">view Details</a>
						 <a href=""class="btn btn-danger btn-sm ml-1"><i class="fas fa-rupee-sign"></i><%=p.getPrice()%></a>
						</div>
					</div>
				</div>
			</div>
